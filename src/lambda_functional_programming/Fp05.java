...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.println("ortalamaPuanlarVerilenSayıdanBüyükMü:"
                + ortalamaPuanlarVerilenSayıdanBüyükMü(coursesList, 75));
        System.out.println("varMı:" +
                kursAdlarindanEnAzBirininVErilenKelimeyiIceriyorMu(coursesList, "Turkish"));
        ...
        System.out.println(ortalamaPuanaGoreSiralaVeIlkVerilenleriAtla(coursesList,3));
            ...
            }//1- Tüm ortalama puanları verilen sayidan büyük olup olmadıgını kontrol etmek için bir method olusturun

    public static boolean ortalamaPuanlarVerilenSayıdanBüyükMü(List<Courses> list, double x) {
    ...
    public static boolean kursAdlarindanEnAzBirininVErilenKelimeyiIceriyorMu(List<Courses> list, String kelime) {
